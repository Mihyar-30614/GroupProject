...
@EActivity(R.layout.activity_athlete_steps)
@OptionsMenu(R.menu.menu_readings)
public class AthleteStepsActivity extends AppCompatActivity implements ServiceConnection {

    private static final String TAG = AthleteStepsActivity.class.getSimpleName();
    ...
    void onDataAvailable(Intent intent) {
        ...
        switch (characteristic) {
            ...
            case LIGHT:
                break;
            case STEPS:
                stepsToday.setText("You've Walked "+data.toString()+" Step(s).");

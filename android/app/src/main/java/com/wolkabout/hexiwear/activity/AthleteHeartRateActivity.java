...
public class AthleteHeartRateActivity extends AppCompatActivity implements ServiceConnection {

    private static final String TAG = AthleteHeartRateActivity.class.getSimpleName();
